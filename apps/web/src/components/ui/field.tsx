...
function Field({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: ShadCN Field is a generic container, not every field should be a fieldset.
		<div
			role="group"
			data-slot="field"
		...
		return (
			<ul className="ml-4 flex list-disc flex-col gap-1">
				{uniqueErrors.map(
					(error, index) =>
						error?.message && (
							// biome-ignore lint/suspicious/noArrayIndexKey: Generated by ShadCN UI.
